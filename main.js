...
var createBtn = function(key, lv, obj) {
	...
	if (lv > 9) {
		...
		if (lv == 10) {
			out += '<button type="button" id="btnLv' + lv + '" class="btn btn-secondary btn-primary btn-block" onclick="main(' + btnKey + ',' + btnLv + ', this)"><strong>' + obj.innerHTML + ':' + $("#keyword").val() + '<strong></button>';
		} else {
